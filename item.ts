export default {
    ...
    SKILL_LEVEL_REQUIREMENT_EQUIP: 'Для его использования ваш {{skill}} должен быть не ниже {{level}}.',
    TOTAL_LEVEL_REQUIREMENT: 'Чтобы экипировать этот предмет, ваш общий уровень должен быть не ниже {{level}}.'
} as const;
